...
export function AlumniPage() {
  return (
    <div className="flex h-full flex-col items-center justify-center gap-4 py-24 text-center">
      ...
      <div>
        <h2 className="text-lg font-semibold text-slate-700">Alumni</h2>
        <p className="mt-1 text-sm text-slate-400">Alumni directory and engagement features coming soon.</p>
      </div>
